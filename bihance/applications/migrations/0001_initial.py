    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('duration', models.TextField(blank=True, choices=[('Less than 1 month', 'Less Than 1 Month'), ('1-3 months', 'One To Three Months'), ('3-6 months', 'Three To Six Months'), ('6-12 months', 'Six To Twelve Months'), ('1+ year', 'One Plus Year'), ('Ongoing', 'Ongoing')], db_column='Duration', null=True)),
                ('pay_type', models.TextField(blank=True, choices=[('Hourly', 'Hourly'), ('Daily', 'Daily'), ('Weekly', 'Weekly'), ('Monthly', 'Monthly'), ('Project-based', 'Project Based'), ('Negotiable', 'Negotiable')], db_column='PayType', null=True)),
                ('employer_id', models.ForeignKey(db_column='id', on_delete=django.db.models.deletion.DO_NOTHING, to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'db_table': 'Job',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('employee_id', models.ForeignKey(db_column='id', on_delete=django.db.models.deletion.DO_NOTHING, related_name='applications_as_employee', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['job_id'], name='Application_jobId_f46fd1_idx'),
        ),
        migrations.AddIndex(
            model_name='application',
            index=models.Index(fields=['employee_id'], name='Application_id_c3299c_idx'),
        ),
        migrations.AddIndex(
            model_name='application',
