...
class FilesViewSet(viewsets.ModelViewSet): 
    ...
    def list(self, request): 
        ...
        aobject_lookup_class, aobject_lookup_field = self.atype_to_aobject_lookup_map[associated_type]
        try: 
    ...
    def create(self, request): 
        ...
        return HttpResponse(f"File created successfully with file key: {file.file_key}.", status=200)
