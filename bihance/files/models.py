...
class Files(models.Model):
    ...
    associated_user = models.ForeignKey(User, null=True, blank=True, on_delete=models.PROTECT, db_column="associatedUser")
    associated_job = models.ForeignKey(Job, null=True, blank=True, on_delete=models.PROTECT, db_column="associatedJob")
    associated_company = models.ForeignKey(EmployerProfile, null=True, blank=True, on_delete=models.PROTECT, db_column="associatedCompany")
