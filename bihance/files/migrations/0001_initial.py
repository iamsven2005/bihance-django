        ...
        migrations.CreateModel(
            ...
            fields=[
                (
                    "file_key",
                    models.TextField(
                        db_column="fileKey", primary_key=True, serialize=False
                    ),
                ),
                ...
                (
                    ...
                    models.TextField(
                        ...
                        db_column="associatedType",
                    ),
                ),
                (
                    "associated_group_message",
                    models.TextField(
                        blank=True, db_column="associatedGroupMessage", null=True
                    ),
                ),
                (
                    "associated_company",
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["associated_message"], name="File_associa_4f7a9f_idx"
                    ),
                    models.Index(
                        fields=["associated_group_message"],
                        name="File_associa_338741_idx",
                    ),
                    models.Index(
                        fields=["associated_user"], name="File_associa_6d635f_idx"
                    ),
                    models.Index(
                        fields=["associated_job"], name="File_associa_79f7b4_idx"
                    ),
                    models.Index(
                        fields=["associated_company"], name="File_associa_94326b_idx"
                    ),
                ],
                "constraints": [
                    models.CheckConstraint(
                        condition=models.Q(
                            ...
                            models.Q(
                                ...
                                ("associated_user__isnull", False),
                            ),
                            models.Q(
                                ("associated_company__isnull", True),
                                ("associated_group_message__isnull", True),
                                ("associated_job__isnull", False),
                                ("associated_message__isnull", True),
                                ("associated_type", "Job"),
                                ("associated_user__isnull", True),
                            ),
                        ...
                        name="files_file_only_one_associated_object",
                    )
                ],
            },
        ),
